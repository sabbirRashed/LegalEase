                                ...
                                <form onSubmit={profile?._id ? handleUpdateProfile : handleSubmitProfile} className="flex flex-col gap-4">
                                    ...
                                    <div className='flex flex-col-reverse sm:flex-row justify-between items-center gap-6 md:gap-8'>
                                        ...
                                        <div className='flex-1 space-y-4 w-full'>
                                            <TextField className="w-full" name="name" type="text" defaultValue={profile?.name || user?.name} variant="secondary">
                                                <Label>Name</Label>
                                            ...
                                            {/* email */}
                                            <TextField className="w-full" name="email" type="email" isReadOnly defaultValue={user?.email} variant="secondary">
                                                <Label>Email</Label>
